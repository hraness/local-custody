...
function parseEntry(value) {
  ...
  if (engine === null || abi === null || crate === null || target === null || files === null || primary === null || sha256 === null || kind !== "cargo-native" || !files.includes(primary) || typeof bytes !== "number" || !Number.isSafeInteger(bytes) || bytes < 1 || !(maxInputBytes === null || typeof maxInputBytes === "number" && Number.isSafeInteger(maxInputBytes) && maxInputBytes >= 1))
    return null;
...
function parseLocalCustodyArtifactManifest(value) {
...
async function loadLocalCustodyArtifactManifest() {
  try {
...
function findLocalCustodyArtifact(manifest, abi, target) {
...
export {
  parseLocalCustodyArtifactManifest,
  loadLocalCustodyArtifactManifest,
  findLocalCustodyArtifact
};
